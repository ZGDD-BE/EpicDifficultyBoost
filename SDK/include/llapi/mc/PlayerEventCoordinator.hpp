...
public:
     ...
     */
    //MCAPI void sendEvent(EventRef<PlayerGameplayEvent<void>> const &);
    /**
     ...
     */
    //MCAPI enum class CoordinatorResult sendEvent(EventRef<PlayerGameplayEvent<enum class CoordinatorResult>> const &);
    /**
