...
// underscore(_). 
#define PLUGIN_NAME "EpicDifficultyBoost"
// Describe what your plugin does
// We recommend you start the introduction with a third-person singular verb.
#define PLUGIN_INTRODUCTION "This is a BDS plugin, designed to elevate game difficulty by significantly augmenting monster abilities etc."
